...
const GET_CLOUSURES_BY_CASH_REGISTER_ID = `select 
	fechamentos.id, fechamentos.valor_pago_real as realbr, fechamentos.valor_pago_dolar dolar, fechamentos.valor_pago_peso as peso, 
	...
	conta_cliente.id as id_conta_cliente, conta_cliente.valor_total as valor_total, conta_cliente.status, 
