/* Tabela Pais */
const SELECT_OCCUPATIONS = `SELECT id, nome, detalhes FROM funcao;`
const SELECT_OCCUPATION_BY_ID = `SELECT id, nome, detalhes FROM funcao WHERE id = ($1);`
const SELECT_OCCUPATION_BY_NAME = `SELECT id, nome, detalhes FROM funcao WHERE nome like $1;`
