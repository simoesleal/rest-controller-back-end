/* Tabela Pais */
const SELECT_TYPES_DOCUMENT = `SELECT id, tipo_documento, descricao, status FROM tipo_documento;`

const SELECT_TYPE_DOCUMENT = `SELECT id, tipo_documento, descricao, status FROM tipo_documento WHERE id = ($1);`

const SELECT_TYPE_DOCUMENT_BY_NAME = `SELECT id, tipo_documento, descricao, status FROM tipo_documento WHERE tipo_documento like ($1);`
